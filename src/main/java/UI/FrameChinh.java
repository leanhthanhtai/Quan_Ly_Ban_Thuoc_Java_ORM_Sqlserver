...
public class FrameChinh extends JFrame implements ActionListener, MouseListener, MenuListener{
	...
	private JMenu menuTrangChu, menuThuHoi ,menuThuoc, menuNhanVien, menuKhachHang, menuNSX, menuHoaDon, menuThongKe, menuHelp;
	private JMenuItem miAbout,menuLoaiThuoc;

	private CardLayout cardLayout;
	private JPanel pTrangChu, pthuoc, pKhachHang, pNSX, pNhanVien, pHoaDon, pThongKe, pThuHoi;
	private JDialog pLoaiThuoc;
	...
	public void taoCardLayout() {
		...
		pThuHoi = new PanelTimKiemHoaDon();
	...
	public void taoMenubar() {
		...
		menuThuHoi = new JMenu("TÌM KIẾM HÓA ĐƠN");
		menuThuHoi.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 16));
		...
		menuLoaiThuoc = new JMenuItem("LOẠI THUỐC");
...
//		menuLoaiThuoc.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 16));
		...
		menuHelp.add(menuLoaiThuoc);
		menuBar.add(menuTrangChu);
		menuBar.add(menuHoaDon);
		menuBar.add(menuThuoc);
		menuBar.add(menuThuHoi);
//		menuBar.add(menuLoaiThuoc);
	...
	public void themMenuListener() {
		...
		menuThuHoi.addMenuListener(this);
		menuLoaiThuoc.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(miAbout)) {
			...
			if(o.equals(menuLoaiThuoc)) {
				DiaLogLoaiThuoc lThuoc = new DiaLogLoaiThuoc(this);
			}
	}
	...
	public void menuSelected(MenuEvent e) {
		...
		if (object.equals(menuTrangChu)) {
		 ...
		 else if (object.equals(menuThuHoi)) {
				cardLayout.show(this.getContentPane(), "ThuHoi");
