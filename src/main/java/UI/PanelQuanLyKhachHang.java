...
//		cbGioiTinh.setFont(new Font(Font.SANS_SERIF, Font.LAYOUT_LEFT_TO_RIGHT, 16));
	...
	public void xuLyThemKH() {
		txtMa.setText(khachHangDAO.setCodeEmployees());
	...
	public boolean kiemTraDuLieu() {
		if (kiemTraMaKH(txtMa.getText().trim()) == false) {
		 ...
		 else if (KiemTraTheoEmail(txtEmail.getText().trim()) == false) {
				JOptionPane.showMessageDialog(this, "Email phải có '@' và bắt đầu bằng chữ !");
				return false;
			}
		return true;
	...
	public Boolean KiemTraTheoEmail(String ten) {
		String regexTen = "^[a-zA-Z][a-zA-Z0-9]+[@][a-zA-Z]+[.][a-zA-Z]+$";
